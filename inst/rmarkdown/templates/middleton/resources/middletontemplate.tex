%% Template for a CV
%% Author: Rob J Hyndman with edits by kevin Middleton
...
$else$
\definecolor{headcolor}{HTML}{000080}
$endif$
...
$if(pubmed)$\faicon{university} & \href{https://www.ncbi.nlm.nih.gov/myncbi/$pubmed$/bibliography/public/}{NIH PubMed}\\$endif$%
$if(orcid)$\faicon{openid} & \href{https://orcid.org/$orcid$}{ORCiD: $orcid$}\\$endif$%
$if(twitter)$\faicon{twitter} & \href{https://twitter.com/$twitter$}{@$twitter$}\\$endif$%
$if(github)$\faicon{github} & \href{https://github.com/$github$}{GitHub: $github$}\\$endif$%
$if(linkedin)$\faicon{linkedin} & \href{https://www.linkedin.com/in/$linkedin$}{$linkedin$}\\$endif$%
$if(scholar)$\faicon{google} & \href{https://scholar.google.com/citations?user=$scholar$}{Google Scholar}\\$endif$%
}
